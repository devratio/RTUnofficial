...
{
    // TODO: consider making a template maybe? 
    public class EpisodesSource : ObservableCollection<Models.EpisodeData>, ISupportIncrementalLoading
    {
        ...
        {
            _last_request_result = await SVODRepo.GetEpisodes(Page, PerPage, Endpoint);
