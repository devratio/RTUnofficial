...
namespace RTUnofficial.App
{
    ...
    public sealed partial class SeasonsPage : Page
    {
        ...
        private ApiClient.RTPagedSource<ApiClient.Models.EpisodeData> _test = null;
        public SeasonsPage()
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter != null && e.Parameter is ApiClient.Models.ShowData)
            {
                ...
                //_test = new ApiClient.RTPagedSource<ApiClient.Models.EpisodeData>()
                //{ Endpoint = _seasons.Data.First().Links.Episodes };
            }
            Bindings.Update();
        }
